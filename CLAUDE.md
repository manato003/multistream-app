...
共通ワークフロー・原則は親ディレクトリの `../CLAUDE.md` に定義されており、自動適用される。
...
- コミット: `cd "C:\Users\manat\OneDrive\Desktop\claude\projects\multistream-app"; git add <files>; git commit -m "メッセージ"`
